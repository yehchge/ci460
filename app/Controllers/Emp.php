...
class Emp extends ResourcePresenter
{
    ...
    {
        return view('employee/index', ['employee' => $this->model->findAll()]);
    }
    ...
    {
        return view('employee/edit', ['employee' => $this->model->where('id', $id)->first()]);
    }
